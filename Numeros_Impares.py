...
# instanciamos uma lista, onde os números digitados serão armazenados 
numeros = []
...
# com a estrutura "while", condicionamos que o bloco de código se repita enquanto o contador for menor que 6, ou seja, 5 vezes
while i < 6:
    try:
